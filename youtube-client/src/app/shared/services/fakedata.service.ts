...
import IVideosResponseData from 'src/app/core/components/search/search-response.model';

@Injectable({
  'providedIn': 'root',
})
export default class FakedataService {
  fakeData: IVideosResponseData = {
    ...
    'items': [
      ...
      },
      {
        ...
        'id': 'Fdf5aTYRW0E',
        'snippet': {
          'publishedAt': '2022-08-13T17:46:58.000Z',
      ...
      },
      {
        ...
        'snippet': {
          ...
          'localized': {
            'title': 'What is Angular? (Explained for Beginners)',
            'description': 'When you\'re just starting out you are probably wondering "What is Angular exactly? When you ask that question it leads to a lot of concepts that are over your head and don\'t make sense. So in this video I really want to cover what exactly Angular is and why it\'s even necessary... all from a beginners point of view.\n\n*** DOWNLOAD THE FREE REPORT ***\nFor my free report on the five best programming languages in 2019 (for beginners) go to: https://andysterkowitz.com/report\'description\'description\'',
          },
          'defaultAudioLanguage': 'en',
        },
        'statistics': {
